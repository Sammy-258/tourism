...
<head>
    ...
    <link rel="stylesheet" href="../style/occasion.css">
...
<body>
            ...
            <div class="container">
                <div class="row mt-5" style="margin-top:7rem !important;">
                    <div class="col-lg-6 mt-5">
                        <p class="welcoming-text-heading">FESTIVALS</p>
                    </div>
                </div>
            </div>
    ...
    <section class="third-section position-relative" style="top:-5rem;">
        <div class="container-lg">
            <div class="col-lg-11 col-md-12 px-0 m-auto">
                <div class="col-lg-6">
                    <p class="third-heading-text">SELECT FESTIVAL</p>
                    
                </div>
                <div class="row gy-4">
                    <div class="col-lg-6 col-md-6 col-12 position-relative">
                        <img src="../images/occasion1.png" alt="">
                        <div class="d-block position-absolute px-3" style="bottom:1.5rem;">
                            <p class="tourist-name">LOREM IPSUM</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12 position-relative">
                        <img src="../images/occasion2.png" alt="">
                        <div class="d-block position-absolute px-3" style="bottom:1.5rem;">
                            <p class="tourist-name">LOREM IPSUM</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12 position-relative">
                        <img src="../images/occasion3.png" alt="">
                        <div class="d-block position-absolute px-3" style="bottom:1.5rem;">
                            <p class="tourist-name">LOREM IPSUM</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12 position-relative">
                        <img src="../images/occasion4.png" alt="">
                        <div class="d-block position-absolute px-3" style="bottom:1.5rem;">
                            <p class="tourist-name">LOREM IPSUM</p>
                        </div>
                    </div>
