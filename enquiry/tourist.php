    ...
    <section class="second-section my-5">
        <div class="container">
            <div class="col-lg-12 m-auto">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="first-description-text">Jorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet f. Alimagna. Nam metu</p>
                    </div>
                </div>
            </div>

            <div class="col-lg-12 col-12 position-relative">
                <img src="images/vedio_tag.png" alt="">
                <div class="d-flex justify-content-center position-absolute" style="width:100%;top:40%;">
                    <div class="pause-div p-4">
            ...
            <div class="col-lg-12 mt-5">
                <p class="more_images">MORE IMAGES</p>
            </div>

            <div class="swiper mySwiper my-4">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="images/tourist1.png" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="images/tourist2.png" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="images/tourist3.png" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="images/tourist1.png" alt="">
                    </div>
            ...
            <div class="col-lg-12">
                <p class="description-text">Jorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet f. Alimagna. Nam metu</p>
            </div>
            <div class="col-lg-12 d-flex justify-content-end">
                <button class="tourist_btn"> Book a Hotel </button>
            </div>
        </div>
    </section>
